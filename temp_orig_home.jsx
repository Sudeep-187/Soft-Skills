...
/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
   STATE REVEAL ΓÇö Full-screen parallax + 3D entrance (no products)
   ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */
...
export default function Home() {
  ...
  return (
    <div className="bg-black">
      ...
      {/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ HERO ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */}
        ...
        <motion.div className="relative z-10 h-full flex flex-col justify-center px-8 md:px-20 max-w-7xl mx-auto"
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[9px] font-bold uppercase tracking-[0.4em] mb-8"
              ...
              Γ£ª Four States ┬╖ 44 Masterpieces ┬╖ One Mission
            </div>
      ...
      {/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ STATES (one per viewport, no products) ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */}
      {STATES_DATA.map((s, i) => (
        <StateReveal key={s.name} state={s} index={i} />
      ))}

      {/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ STATS ΓÇö scroll-revealed ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */}
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-8 md:px-20">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-10 md:gap-16">
            ...
            <Stat value="4.8 Γÿà" label="Average Rating" icon={<Star className="w-6 h-6" />} delay={0.3} />
          </div>
        </div>
      </section>

      {/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ NEWSLETTER ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */}
