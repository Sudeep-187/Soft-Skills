...
import { Search, X, ArrowRight, Star, Heart, ShoppingCart, MapPin, Sparkles } from 'lucide-react';
import { motion, useScroll, useTransform } from 'framer-motion';
import { createPageUrl } from '../../utils';

const CATEGORIES = [
  { value: 'handloom', label: 'Handloom', icon: '≡ƒº╡' },
  { value: 'paintings', label: 'Paintings', icon: '≡ƒÄ¿' },
  { value: 'woodcraft', label: 'Woodcraft', icon: '≡ƒ¬╡' },
  { value: 'metalwork', label: 'Metalwork', icon: '≡ƒö¿' },
  { value: 'spices', label: 'Spices', icon: '≡ƒî╢∩╕Å' },
  { value: 'jewelry', label: 'Jewelry', icon: '≡ƒÆÄ' },
];
...
/*  ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
    LAYOUT PATTERNS ΓÇö cycles through these for visual variety
    Each pattern defines width, alignment, image-side, rotation direction
    ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */
const PATTERNS = [
  // Pattern 0: HERO ΓÇö full bleed background, text overlay
  { type: 'hero' },
  // Pattern 1: Left-lean ΓÇö image left 60%, info right, rotate from left
  { type: 'split', imgSide: 'left', width: '92%', align: 'flex-start', rotDir: -1, skew: -2 },
  // Pattern 2: Right-lean ΓÇö image right 60%, info left, rotate from right
  { type: 'split', imgSide: 'right', width: '88%', align: 'flex-end', rotDir: 1, skew: 2 },
  // Pattern 3: Center float ΓÇö narrower, centered, tilted forward
  { type: 'center', width: '75%', rotDir: -1, skew: 0 },
  // Pattern 4: Wide left
  { type: 'split', imgSide: 'left', width: '95%', align: 'flex-start', rotDir: 1, skew: -1 },
  // Pattern 5: Compact right
  { type: 'split', imgSide: 'right', width: '80%', align: 'flex-end', rotDir: -1, skew: 1 },
];

/*  ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
    HERO PRODUCT ΓÇö Full-bleed background, overlay text
    ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */
    ...
    <section ref={ref} className="relative overflow-hidden rounded-3xl mx-4 md:mx-8 mb-8" style={{ height: '85vh' }}>
      ...
      >
        <div className="flex flex-wrap gap-2 mb-4">
          ...
          {product.is_featured && <span className="px-3 py-1 text-xs font-bold rounded-full text-black" style={{ background: '#D4A017' }}>Γ£ª Top Pick</span>}
        </div>
        ...
        <div className="flex items-center gap-4 mt-6">
          <span className="text-3xl md:text-4xl font-bold text-white">Γé╣{product.price?.toLocaleString('en-IN')}</span>
          {product.original_price && <span className="text-lg text-white/30 line-through">Γé╣{product.original_price?.toLocaleString('en-IN')}</span>}
        ...
        <div className="flex gap-3 mt-8">
          <button className="px-8 py-4 rounded-full text-sm font-bold text-black flex items-center gap-2 transition hover:shadow-[0_0_30px_rgba(212,160,23,0.5)]" style={{ background: '#D4A017' }}>
            <ShoppingCart className="w-4 h-4" /> Add to Cart
          </button>
          <button className="w-12 h-12 rounded-full flex items-center justify-center text-white/50 hover:text-red-400 transition" style={{ background: 'rgba(255,255,255,0.1)', backdropFilter: 'blur(8px)' }}>
...
/*  ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
    SPLIT PRODUCT ΓÇö Image one side, text the other, 3D scroll-linked
    ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */
function SplitProduct({ product, pattern, stateColor }) {
  const ref = useRef(null);
  const { scrollYProgress } = useScroll({ target: ref, offset: ['start end', 'end start'] });

  // Continuous bidirectional transforms
  ...
  return (
    <motion.section
      ...
      style={{
        display: 'flex', justifyContent: pattern.align,
        perspective: 1200,
      }}
    >
      <motion.div
        style={{
          width: pattern.width, rotateY, rotateX, x, opacity, scale, skewY,
          transformStyle: 'preserve-3d', willChange: 'transform, opacity',
        }}
      >
        <div className={`flex flex-col ${isRight ? 'md:flex-row-reverse' : 'md:flex-row'} rounded-3xl overflow-hidden`}
          style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.05)' }}>

          {/* Image */}
          <div className="relative w-full md:w-3/5 overflow-hidden" style={{ minHeight: '55vh' }}>
            ...
            <div className="absolute top-5 left-5 flex flex-col gap-2 z-10">
              ...
              {product.is_festival_special && <span className="px-3 py-1 text-black text-xs font-bold rounded-full" style={{ background: '#E8BB3A' }}>≡ƒÄë Festival</span>}
            </div>
          </div>

          {/* Info */}
          <div className="w-full md:w-2/5 flex flex-col justify-center p-8 md:p-12">
            ...
            <div className="flex items-center gap-3 mt-8">
              <span className="text-2xl md:text-3xl font-bold text-white">Γé╣{product.price?.toLocaleString('en-IN')}</span>
              {product.original_price && <span className="text-sm text-white/20 line-through">Γé╣{product.original_price?.toLocaleString('en-IN')}</span>}
            ...
            <div className="flex gap-3 mt-6">
              <button className="flex-1 py-3.5 rounded-full text-sm font-bold text-black flex items-center justify-center gap-2 transition hover:shadow-[0_0_25px_rgba(212,160,23,0.4)]" style={{ background: '#D4A017' }}>
                <ShoppingCart className="w-4 h-4" /> Add to Cart
              </button>
              <button className="w-11 h-11 rounded-full flex items-center justify-center text-white/30 hover:text-red-400 transition" style={{ border: '1px solid rgba(255,255,255,0.08)' }}>
...
/*  ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
    CENTER PRODUCT ΓÇö Narrower, centered, dramatic tilt
    ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */
function CenterProduct({ product, pattern, stateColor }) {
  ...
  return (
    ...
    >
      <motion.div
        style={{ width: pattern.width, rotateX, rotateZ, y, opacity, scale, transformStyle: 'preserve-3d', willChange: 'transform, opacity' }}
      >
        <div className="rounded-3xl overflow-hidden relative" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.05)' }}>
          ...
          <div className="relative overflow-hidden" style={{ height: '50vh' }}>
            ...
            <div className="absolute top-5 left-5 flex gap-2 z-10">
              {discount > 0 && <span className="px-3 py-1 text-white text-xs font-bold rounded-full bg-red-600">-{discount}%</span>}
              {product.is_featured && <span className="px-3 py-1 text-black text-xs font-bold rounded-full" style={{ background: '#D4A017' }}>Γ£ª Top Pick</span>}
            </div>
          ...
          <div className="p-6 md:p-8 flex flex-col md:flex-row items-start md:items-center gap-4">
            ...
            <div className="flex items-center gap-4 shrink-0">
              <div>
                <span className="text-2xl font-bold text-white">Γé╣{product.price?.toLocaleString('en-IN')}</span>
                {product.original_price && <span className="block text-xs text-white/20 line-through">Γé╣{product.original_price?.toLocaleString('en-IN')}</span>}
              </div>
              <button className="px-6 py-3 rounded-full text-sm font-bold text-black flex items-center gap-2 transition hover:shadow-[0_0_25px_rgba(212,160,23,0.4)]" style={{ background: '#D4A017' }}>
                <ShoppingCart className="w-4 h-4" /> Add
              </button>
              <button className="w-10 h-10 rounded-full flex items-center justify-center text-white/30 hover:text-red-400 transition" style={{ border: '1px solid rgba(255,255,255,0.08)' }}>
                <Heart className="w-4 h-4" />
              </button>
            </div>
          </div>
...
/*  ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
    PRODUCT RENDERER ΓÇö picks the right layout per index
    ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */
...
export default function Products() {
  ...
  const filtered = useMemo(() => {
    let r = [...products];
    if (searchQuery) r = r.filter(p => p.name.toLowerCase().includes(searchQuery.toLowerCase()) || p.village?.toLowerCase().includes(searchQuery.toLowerCase()));
  ...
  return (
    <div className="bg-black min-h-screen text-white">
      ...
      <section ref={heroRef} className="relative h-[55vh] md:h-[65vh] overflow-hidden flex items-end">
        <motion.div className="absolute inset-0 -top-[30%]" style={{ y: heroBgY, willChange: 'transform' }}>
          <img src={stateData?.image || 'https://images.unsplash.com/photo-1558769132-cb1aea458c5e?w=1920&h=800&fit=crop&q=75'}
            alt={pageTitle} className="w-full h-[160%] object-cover" loading="eager" />
        </motion.div>
        <div className="absolute inset-0" style={{
          background: stateData
            ? `linear-gradient(225deg, ${stateAccent}BB 0%, rgba(0,0,0,0.92) 70%)`
            : 'linear-gradient(to top, #000 0%, rgba(0,0,0,0.3) 50%, rgba(0,0,0,0.6) 100%)'
        }} />
        <motion.div className="relative z-10 max-w-7xl mx-auto w-full px-8 md:px-16 pb-12" style={{ opacity: heroTxtOp, y: heroTxtY }}>
          <span className="text-[10px] font-bold uppercase tracking-[0.4em] mb-4 block" style={{ color: stateAccent }}>
            {stateData?.tagline || "South India's Heritage"}
          </span>
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-black" style={{ fontFamily: 'Playfair Display, serif' }}>{pageTitle}</h1>
          <p className="text-white/35 text-sm mt-3">{loading ? 'LoadingΓÇª' : `${filtered.length} handcrafted products`}</p>
        </motion.div>
      </section>

      {/* ΓòÉΓòÉ Filter Bar ΓòÉΓòÉ */}
      <div className="sticky top-0 z-40" style={{ background: 'rgba(0,0,0,0.88)', backdropFilter: 'blur(20px)', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
        <div className="max-w-7xl mx-auto px-6 md:px-12 py-3.5">
          <div className="flex items-center gap-2.5 overflow-x-auto scrollbar-hide">
            <button onClick={() => setSelectedState('all')}
              ...
              style={selectedState === 'all' ? { background: '#D4A017', color: '#000' } : { color: 'rgba(255,255,255,0.35)', border: '1px solid rgba(255,255,255,0.06)' }}>
              All
            </button>
            {STATES.map(s => (
              <button key={s.value} onClick={() => setSelectedState(s.value)}
                className="shrink-0 px-4 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-wider transition-all"
                style={selectedState === s.value ? { background: s.color, color: '#fff' } : { color: 'rgba(255,255,255,0.35)', border: '1px solid rgba(255,255,255,0.06)' }}>
                {s.value}
              </button>
            ))}
            <div className="hidden md:block w-px h-4 mx-1" style={{ background: 'rgba(255,255,255,0.06)' }} />
            {CATEGORIES.map(c => (
              <button key={c.value} onClick={() => setSelectedCategory(c.value === selectedCategory ? 'all' : c.value)}
                className="shrink-0 px-3 py-1.5 rounded-full text-[10px] font-semibold transition-all hidden md:block"
                style={selectedCategory === c.value ? { background: 'rgba(255,255,255,0.1)', color: '#fff' } : { color: 'rgba(255,255,255,0.25)' }}>
                {c.icon} {c.label}
              </button>
            ))}
            <select value={sortBy} onChange={e => setSortBy(e.target.value)}
              className="ml-auto shrink-0 text-[10px] bg-transparent text-white/30 outline-none cursor-pointer px-3 py-1.5 rounded-full"
              style={{ border: '1px solid rgba(255,255,255,0.06)' }}>
              <option value="newest" style={{ background: '#111' }}>Newest</option>
              <option value="price_low" style={{ background: '#111' }}>Price Γåæ</option>
              <option value="price_high" style={{ background: '#111' }}>Price Γåô</option>
      ...
      <div className="py-10 md:py-16">
        {loading ? (
          <div className="flex flex-col items-center py-32 text-white/30">
            ...
            <p className="mt-4 text-sm">Loading craftsΓÇª</p>
          </div>
        ) : filtered.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-32 text-center px-6">
            <div className="text-6xl mb-6">≡ƒöì</div>
            <h3 className="text-2xl font-bold text-white mb-2" style={{ fontFamily: 'Playfair Display, serif' }}>No crafts found</h3>
            <p className="text-white/30 text-sm mb-8">Try a different state or category.</p>
            <button onClick={() => { setSelectedCategory('all'); setSelectedState('all'); setSearchQuery(''); }}
              className="px-8 py-3 rounded-full text-sm font-bold text-black" style={{ background: '#D4A017' }}>Clear Filters</button>
          </div>
        ) : (
